...
def test_no_differences(create_json_file):
    # Одинаковые файлы
    file1 = create_json_file("test_file1.json", {"key1": "value1", "key2": "value2"})
    file2 = create_json_file("test_file2.json", {"key1": "value1", "key2": "value2"})
...
def test_key_added(create_json_file):
    ...
    file1 = create_json_file("test_file1.json", {"key1": "value1"})
    file2 = create_json_file("test_file2.json", {"key1": "value1", "key2": "value2"})
    result = generate_diff(str(file1), str(file2))
    expected_output = '''{
    key1: value1
...
def test_key_removed(create_json_file):
    ...
    file1 = create_json_file("test_file1.json", {"key1": "value1", "key2": "value2"})
    file2 = create_json_file("test_file2.json", {"key1": "value1"})
    result = generate_diff(str(file1), str(file2))
    expected_output = '''{
    key1: value1
  - key2: value2
...
def test_value_changed(create_json_file):
    ...
    file1 = create_json_file("test_file1.json", {"key1": "value1", "key2": "value2"})
    file2 = create_json_file("test_file2.json", {"key1": "value1", "key2": "new_value"})
    result = generate_diff(str(file1), str(file2))
    expected_output = '''{
    key1: value1
  - key2: value2
